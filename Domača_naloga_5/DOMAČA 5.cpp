...
int main() {
    ...
    // podamo ime datoteke
    std::string filename = "C:/Users/rutar/OneDrive/Desktop/dn5/datoteka_A_b.txt";
    ...
    std::cout << "Cas po metodi Gauss-Seidel: " << time_duration.count() << " sekund" << std::endl;
...
#pragma omp critical
    ...
    std::cout << "Cas po Gauss-Seidel - OpenMP : " << time_duration_omp.count() << " sekund" << std::endl;
    ...
    cout << "Maksimalna temperatura: " << max_T << " stopinj C." << endl;
